...
// import { View, Button, Text, Alert, ScrollView, Linking } from 'react-native';
// import DocumentPicker, { DocumentPickerResponse } from 'react-native-document-picker';
// import AsyncStorage from '@react-native-async-storage/async-storage';

// const FileUpload: React.FC = () => {
//   // Initialize state for selected files and uploaded files
...
//       });
//       console.log('Selected files:', results); // Debugging statement
//       setFileResponses(results); // Store selected files in state
//     } catch (err: unknown) {
...
//             <Text key={fileResponse.uri}>File: {fileResponse.name}</Text>
//           ))
//         ) : (
